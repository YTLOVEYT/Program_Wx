...
public class ListViewHeader extends BaseHeader
{
    ...
    {
        this(context, com.liaoinstan.springview.R.drawable.progress_small, com.liaoinstan.springview.R.drawable.arrow);
    }

    public ListViewHeader(Context context, int rotationSrc, int arrowSrc)
    {
    ...
    public View getView(LayoutInflater inflater, ViewGroup viewGroup)
    {
        ...
        headerTitle = (TextView) view.findViewById(com.liaoinstan.springview.R.id.default_header_title);
        headerTime = (TextView) view.findViewById(com.liaoinstan.springview.R.id.default_header_time);
        headerArrow = (ImageView) view.findViewById(com.liaoinstan.springview.R.id.default_header_arrow);
        headerProgressbar = (ProgressBar) view.findViewById(com.liaoinstan.springview.R.id.default_header_progressbar);
